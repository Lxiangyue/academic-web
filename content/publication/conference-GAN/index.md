...
summary: A novel sky map repair method based on generative adversarial networks is proposed by this paper. We use generative adversary networks to achieve image-to-image translation by learning the correspond from image-to-image, which obtain a high-precision sky map from the low-precision sky map. 
